...
export class ActivosFijosCrearComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.GetRetenciones();
    this.isAdicion();
    this.http.get(environment.base_url + '/php/comprobantes/lista_cuentas.php', { params: { company_id: this._user.user.person.company_worked.id } }).subscribe((data: any) => {
      this.Cuenta = data.Activo;
    });
    this.http.get(environment.base_url + this.Ruta_Nit, { params: { company_id: this._user.user.person.company_worked.id } }).subscribe((data: any) => {
      this.Cliente = data;
    });
  ...
  getCodigoActivo() {
    this.http.get(environment.base_url + '/php/activofijo/get_codigo.php', { params: { company_id: this._user.user.person.company_worked.id } })
      .subscribe((data: any) => {
  ...
  GuardarActivoFijo(tipo) {
    ...
    if (this.Tipo_Creacion == 'Nuevo') {
      this.http.post(environment.base_url + '/php/activofijo/guardar_activo_fijo.php', data)
        .subscribe((data: any) => {
  ...
  showFacturas(pos) {
    ...
    if (nit) {
      ...
      this.http.get(environment.base_url + '/php/activofijo/lista_facturas.php', { params: p }).subscribe((data: any) => {
  ...
  getCodigo(fecha?: string) {
    ...
    this.http.get(environment.base_url + '/php/activofijo/get_codigo.php', { params: datos }).subscribe((data: any) => {
      this.datosCabecera.Codigo = data.consecutivo;
    })
  }
