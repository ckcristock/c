...
export class NotascarteracrearComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get(environment.base_url + '/php/contabilidad/notascarteras/nit_buscar.php').subscribe((data: any) => {
      this.Cliente = data;
    });
    ...
    this.http.get(environment.base_url + '/php/contabilidad/notascarteras/centrocosto_buscar.php').subscribe((data: any) => {
      this.Centros = data;
    });
