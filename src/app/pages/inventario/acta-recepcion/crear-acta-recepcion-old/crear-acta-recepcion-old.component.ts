...
@Component({
  selector: 'app-crear-acta-recepcion-old',
  templateUrl: './crear-acta-recepcion-old.component.html',
  styleUrls: ['./crear-acta-recepcion-old.component.scss']
})
export class CrearActaRecepcionOldComponent implements OnInit {
