...
export class EditDiarioFixedComponent implements OnInit {
  ...
  makeData() {
    return {
      entry_time_one: this.diario?.entry_time_one
        ? this.diario?.entry_time_one
        : '',
      leave_time_one: this.diario?.leave_time_one
        ? this.diario?.leave_time_one
        : '',
      entry_time_two: this.diario?.entry_time_two
        ? this.diario?.entry_time_two
        : '',
      leave_time_two: this.diario?.leave_time_two
        ? this.diario?.leave_time_two
        : '',
    };
  }
